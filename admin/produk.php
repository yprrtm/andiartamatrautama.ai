		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  if($sql){ 
				$msproduk = "insert into msproduct select * from produk";
			  $msp = mysqli_query($conn, $msproduk);
...
<head>
    ...
    <title>Kelola Produk - PT Andiarta Marta Utama</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								...
								<h2>Daftar Produk</h2>	
								<button style="margin-bottom:8px" data-toggle="modal" data-target="#myModal" class="btn btn-outline-info col-md-2">Tambah Produk</button>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<!-- Modal Edit -->
												<div class="modal fade" id="publish<?=$idp;?>">
                                            ...
                                            <!-- Modal body -->
                                                ...
                                                <input readonly="true" class="form-control" name="rate" value="<?=$p['gambar']?>">
                                                <label>Rate Produk</label>
                                                <input readonly="true" class="form-control" name="rate" value="<?=$p['namaproduk']?>">
                                                <label>Rate Produk</label>
                                                <input readonly="true" class="form-control" name="rate" value="<?=$p['hargaafter']?>">
                                                <label>Rate Produk</label>
                                                <input readonly="true" class="form-control" name="rate" value="<?=$p['deskripsi']?>">
                                           		</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
							...
							<?php 
								$pub=mysqli_query($conn,"SELECT * FROM produk");
								while($q=mysqli_fetch_array($pub)){
									$idp = $q['namaproduk'];
									$rproduk = $q['rate'];
							?>
							<option><?=$idp;?></option>
							...
							?>
								...
								<div class="form-group">
									<label>Rate Produk</label>
									<select name="rproduk" class="form-control">
									 <input readonly="true" class="form-control" name="kode" value="<?= $q['rate'] ?>">
