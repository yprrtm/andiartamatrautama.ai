...
include 'counter.php';
add_visitation($conn, "index");
?>

<!DOCTYPE html>
<html>
<head>
<title>PT Andiarta Marta Utama</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		<div class="container">
			...
			<div class="w3ls_logo_products_left">
				<h2><a href="index.php">PT Andiarta Marta Utama</a></h2>
			</div>
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							...
							<div class="agile_top_brands_grids">
										...
										<?php 
											$brgs=mysqli_query($conn,"SELECT * from produk ORDER BY visit DESC");
											$no=1;
														...
														<div class="snipcart-details top_brand_home_details">
																<fieldset>
																	<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><input type="submit" class="button" value="Lihat Produk" /></a>
																				<span class="grey-text text-darken-2"><?php echo $p['visit']; ?><i class="fa-solid fa-xs fa-eye left"></i></span>
																</fieldset>
														</div>
													</div>
												</figure>
										...
										<div class="agile_top_brand_left_grid">
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><img title=" " name="visit" alt=" " src="<?php echo $p['gambar']?>" width="200px" height="200px" /></a>		
															<p><?php echo $p['namaproduk'] ?></p>
															<div class="stars">
															<?php
															$bintang = '<i class="fa fa-star blue-star" aria-hidden="true"></i>';
														...
														<div class="snipcart-details top_brand_home_details">
																<fieldset>
																	<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><input type="submit" name="visit" class="button" value="Lihat Produk" /></a>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>PT Andiarta Marta Utama, DKI Jakarta.</li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 PT Andiarta Marta Utama</p>
			</div>
		</div>
