...
include 'counter.php';
add_visitation($conn, "produk");

//update view
$idproduk = mysqli_real_escape_string($conn,$idproduk);
$idproduk = htmlentities($idproduk);
$sql = mysqli_query($conn, "SELECT * FROM produk WHERE idproduk = $idproduk limit 1");
if(mysqli_num_rows($sql)>0){
	$x=mysqli_fetch_assoc($sql);
	$visit = $x['visit'];
	$sql = mysqli_query($conn, "UPDATE produk SET visit = $visit + 1 WHERE idproduk = $idproduk");
}
/*
...
<html>
<head>
<title>PT Andiarta Marta Utama - Produk</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="PT Andiarta Marta Utama, YogaPratama" />
