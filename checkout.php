...
<html>
<head>
<title>PT Andiarta Marta Utama - Checkout</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di PT Andiarta Marta Utama</span></h1>
        ...
        <h6><?php echo $p['metode'] ?> - <?php echo $p['norek'] ?><br>
        a/n. <?php echo $p['an'] ?></h6><br>
        <br>
		 <hr>
